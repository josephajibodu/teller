...
class GatewayManager
{
    ...
    {
        return new PlanService($this->gateway);
    }

    public function customers()
    {
        return new CustomerService($this->gateway);
    }

    public function subscriptions()
    {
        return new SubscriptionService($this->gateway);
    }

    public function invoices()
    {
        return new InvoiceService($this->gateway);
    }

    public function webhooks()
    {
        return new WebhookService($this->gateway);
    }
}
